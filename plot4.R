plot4<-function(){
  ...
  #topright
  plot(data$datetime,data$Voltage,type="l", main="", xlab="datetime", ylab="Voltage",cex.lab=0.8,cex.axis=0.8)
  
  #bottomright
  plot(data$datetime,data$Global_reactive_power,type="l", main="", xlab="datetime",cex.lab=0.8,cex.axis=0.8)
